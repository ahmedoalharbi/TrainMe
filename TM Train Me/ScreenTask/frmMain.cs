...
namespace ScreenTask
{
    public partial class frmMain : Form
    {
        ...
        public frmMain()
        {
            ...
            this.Text = $"TM v{currentVersion.Major}.{currentVersion.Minor}";
        }
        ...
        private void frmMain_Load(object sender, EventArgs e)
        {
                ...
                Task.Factory.StartNew(() =>
            {
                ...
                var latestGithubReleaseText = wc.DownloadString("https://github.com/ahmedoalharbi/cydia.ahmedoalharbi.io");
                ...
                if (regex.Success && !string.IsNullOrEmpty(regex.Value) && regex.Groups.Count > 1)
                {
                    ...
                    if (newVersion > currentVersion)
                    {
                        ...
                        if (msgResult == DialogResult.Yes)
                        {
                            Process.Start("https://beinapps.net");
                        }
                    }
                }
            });
        ...
        {
            Process.Start("https://beinapps.net");
            Process.Start("http://twitter.com/AHMED0ALHARBI");
        }
